    ...
    return (
        <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white relative overflow-hidden">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute bottom-20 left-20 w-24 h-24 bg-blue-500/10 rounded-lg blur-xl"></div>
            </div>
            ...
            <div className="container-custom relative z-10">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-2">
                        ...
                        {/* ISO Certification */}
                        <div className="inline-flex items-center space-x-3 bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl px-4 py-3 mb-6">
                            <div className="w-8 h-8 gradient-primary rounded-lg flex items-center justify-center">
                                <span className="text-white font-bold text-xs">ISO</span>
                            </div>
                            <span className="text-sm font-medium">{footer.iso}</span>
                        </div>
                ...
                >
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <motion.div variants={itemVariants} className="flex items-start space-x-4">
                            ...
                            <div>
                                <h5 className="font-semibold mb-2">Visit Our Office</h5>
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="fixed bottom-8 right-8 w-12 h-12 gradient-primary rounded-full flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-shadow z-50"
            >
